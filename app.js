...
app.use(cors({
    origin: 'https://deployment-production-dfd1.up.railway.app', // Your frontend URL
    methods: ['GET', 'POST'],
    credentials: true
}));
...
const pool = mysql.createPool({
    ...
    password: process.env.DB_PASSWORD || 'eZvVCPZEyzaNAZswCtXbMjVrwmhfbTJD',
    port: process.env.DB_PORT || 12161,
